...
"""
    ...
    def create_detailed_cost_analysis_tab(self, notebook):
        ...
        self.detailed_other_fixed_cost_var = tk.DoubleVar(value=0.0)
        ttk.Entry(other_cost_frame, textvariable=self.detailed_other_fixed_cost_var, width=15).grid(row=0, column=1, pady=3, padx=5)
        
        ttk.Label(other_cost_frame, text="其他可变成本 (元/kWh):").grid(row=1, column=0, sticky=tk.W, pady=3, padx=5)
    ...
    def init_detailed_cost_summary(self):
        ...
        summary_data = [
            ...
            ('  火电固定成本', '0.00 万元', '0.00 万元'),
            ('  火电可变成本', '0.00 万元', '0.00 万元'),
            ('  碳排放费用', '0.00 万元', '0.00 万元'),
            ('  绿证费用', '0.00 万元', '0.00 万元'),
            ('光伏总成本', '0.00 万元', '0.00 万元'),
            ('  光伏固定成本', '0.00 万元', '0.00 万元'),
            ('  光伏可变成本', '0.00 万元', '0.00 万元'),
            ('风电总成本', '0.00 万元', '0.00 万元'),
            ('  风电固定成本', '0.00 万元', '0.00 万元'),
            ('  风电可变成本', '0.00 万元', '0.00 万元'),
            ('下网总成本', '0.00 万元', '0.00 万元'),
            ('  下网固定成本', '0.00 万元', '0.00 万元'),
            ('  下网可变成本', '0.00 万元', '0.00 万元'),
    ...
    def update_detailed_cost_analysis(self):
        ...
        try:
            ...
            summary_data = [
                ...
                ('  火电固定成本', f"{cost_summary['thermal']['fixed_cost']:.2f} 万元", f"{cost_summary['thermal']['fixed_cost']:.2f} 万元"),
                ('  火电可变成本', f"{cost_summary['thermal']['fuel_cost']:.2f} 万元", f"{cost_summary['thermal']['fuel_cost']:.2f} 万元"),
                ('  碳排放费用', f"{cost_summary['thermal']['carbon_cost']:.2f} 万元", f"{cost_summary['thermal']['carbon_cost']:.2f} 万元"),
                ('  绿证费用', f"{cost_summary['thermal']['green_cert_cost']:.2f} 万元", f"{cost_summary['thermal']['green_cert_cost']:.2f} 万元"),
                ('光伏总成本', f"{cost_summary['pv']['total_cost']:.2f} 万元", f"{cost_summary['pv']['total_cost_by_unit_price']:.2f} 万元"),
                ('  光伏固定成本', f"{cost_summary['pv']['fixed_cost']:.2f} 万元", f"{cost_summary['pv']['fixed_cost']:.2f} 万元"),
                ('  光伏可变成本', f"{cost_summary['pv']['variable_cost']:.2f} 万元", f"{cost_summary['pv']['variable_cost']:.2f} 万元"),
                ('风电总成本', f"{cost_summary['wind']['total_cost']:.2f} 万元", f"{cost_summary['wind']['total_cost_by_unit_price']:.2f} 万元"),
                ('  风电固定成本', f"{cost_summary['wind']['fixed_cost']:.2f} 万元", f"{cost_summary['wind']['fixed_cost']:.2f} 万元"),
                ('  风电可变成本', f"{cost_summary['wind']['variable_cost']:.2f} 万元", f"{cost_summary['wind']['variable_cost']:.2f} 万元"),
                ('下网总成本', f"{cost_summary['grid']['total_cost']:.2f} 万元", f"{cost_summary['grid']['total_cost']:.2f} 万元"),
                ('  下网固定成本', f"{cost_summary['grid']['base_cost']:.2f} 万元", f"{cost_summary['grid']['base_cost']:.2f} 万元"),
                ('  下网可变成本', f"{cost_summary['grid']['variable_cost']:.2f} 万元", f"{cost_summary['grid']['variable_cost']:.2f} 万元"),
                ...
                ('火电总出力', f"{int(cost_summary['thermal']['total_energy']/10000.0)} 万度", f"{int(cost_summary['thermal']['total_energy']/10000.0)} 万度"),
                ('光伏总出力', f"{int(cost_summary['pv']['total_energy']/10000.0)} 万度", f"{int(cost_summary['pv']['total_energy']/10000.0)} 万度"),
                ('风电总出力', f"{int(cost_summary['wind']['total_energy']/10000.0)} 万度", f"{int(cost_summary['wind']['total_energy']/10000.0)} 万度"),
                ('下网总负荷', f"{int(cost_summary['grid']['total_energy']/10000.0)} 万度", f"{int(cost_summary['grid']['total_energy']/10000.0)} 万度"),
                # 添加度电成本信息
