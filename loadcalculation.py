    ...
    def update_detailed_cost_analysis(self):
        ...
        try:
            ...
            summary_data = [
                ...
                ('  光伏固定成本', f"{cost_summary['pv']['fixed_cost']:.2f} 万元", '0.00 万元'),
                ('  光伏可变成本', f"{cost_summary['pv']['variable_cost']:.2f} 万元", f"{cost_summary['pv']['total_cost_by_unit_price']:.2f} 万元"),
                ('风电总成本', f"{cost_summary['wind']['total_cost']:.2f} 万元", f"{cost_summary['wind']['total_cost_by_unit_price']:.2f} 万元"),
                ('  风电固定成本', f"{cost_summary['wind']['fixed_cost']:.2f} 万元", '0.00 万元'),
                ('  风电可变成本', f"{cost_summary['wind']['variable_cost']:.2f} 万元", f"{cost_summary['wind']['total_cost_by_unit_price']:.2f} 万元"),
